...
<body class="gray-bg">
					...
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<td>入校时间：</td>
								<td>
									<input placeholder="选择时间" id="txt_search_entrytime1" name="entrytime" class="laydate-icon form-control layer-date"/>									
								</td>
							</tr>
							<tr>
							</tr>
					...
					<form id="form_addtemp" method="post" action="addtemp.htm">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>入校时间：</td>
								<td colspan="4">
									<input placeholder="选择时间" id="txt_search_entrytime"   name="entrytime" class="laydate-icon form-control layer-date"/>									
								</td>
							</tr>
							<tr>
							</tr>
	...
	<div class="modal fade" id="modal_user_echarts" role="dialog" aria-labelledby="modal_user_echarts" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
							<div style="height: 300px;width: 600px" id="main">
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_echarts").click(function(){
	    			var echartsStu = echarts.init(document.getElementById("main"));
	    			    ...
	    			    success:function(res){
	    			    	...
	    			    	if(res.success){
		    			    	...
		    			    	res.elist.forEach(function(stu){
		    			    		xdata.push(stu.tname);
		    			    		ydata.push({value:stu.num,name:stu.tname});
		    			    	})
		    			    	option = {
		    			    		    title: {
		    			    		        text: '某站点用户访问来源',
	...
	function initEditUser(getSelection){
		...
		$('#txt_search_entrytime1').val(new Date(getSelection.entrytime).Format("yyyy-MM-dd"));
	}
