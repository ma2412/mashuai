...
<body class="gray-bg">
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>学生姓名：</td>
								<td colspan="4"><input type="text" id="sName" name="sName"
									class="form-control" aria-required="true" required/></td>
							</tr>
							<tr>
								<td>学生性别：</td>
								<td colspan="4">
									<input type="radio" id="sSex" name="sSex" value="男" required/>男
									<input type="radio" id="sSex" name="sSex" value="女" required/>女
								</td>
							</tr>
							<tr>
								<td>学生爱好：</td>
								<td colspan="4">
									<input type="checkbox" id="sHobby1" name="sHobby" value="篮球" required/>篮球
									<input type="checkbox" id="sHobby2" name="sHobby" value="足球" required/>足球
									<input type="checkbox" id="sHobby3" name="sHobby" value="排球" required/>排球
								</td>
							</tr>
							<tr>
								<td>学生生日：</td>
								<td colspan="4"><input type="date" id="sBirth" name="sBirth" required/></td>
							</tr>
							<tr>
								<td>专业：</td>
								<td colspan="4">
				...
				<div class="modal-body">
					<form id="form_addtemp" method="post" action="addtemp.htm">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>学生专业：</td>
								<td colspan="4"><input type="text" id="mName" name="mName"
									class="form-control" aria-required="true" required/></td>
							</tr>
						</table>
						<div class="modal-footer">
	...
	<div class="modal fade" id="modal_user_import" role="dialog" aria-labelledby="modal_user_import" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="importStu.htm" id="form_import" method="post" enctype="mutilpart/form-data">
						<input type="file" name="fileExc">
					</form>
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_echarts").click(function(){
	    		var echartsoption = echarts.init(document.getElementById("main"));
	    			...
	    			$.ajax({
	    			    ...
	    			    success:function(res){
	    			    	...
	    			    	if(res.success){
		    		    		//循环集合
		    			    	res.elist.forEach(function(stu){
		    			    		xdata.push(stu.mname);
		    			    		ydata.push({value:stu.num,name:stu.mname});
		    			    	})
		    			    	option = {
    			    			    xAxis: {
    			    			    	type: 'category',
	...
	function initEditUser(getSelection){
		...
		$('#mId').val(getSelection.mId);
		$('input[value="'+getSelection.sSex+'"]').attr("checkbox");
