...
<body class="gray-bg">
        ...
        <div class="row">
			 ...
			 <div class="form-horizontal m-t">			  
			  <div class="form-group col-lg-7">
                 <label class="col-sm-2 control-label">入职时间区间查</label>
                 <div class="col-sm-8">
					...
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>密码：</td>
								<td>
									<input type="radio" id="sex" name="sex"  value="男" aria-required="true" required/>男
							...
							<tr>
								<td>特点：</td>
								<td colspan="4">
				                	<input type="checkbox" name="expressTrait" id="expressTrait1" value="耐心" aria-required="true" required/>耐心
				                	<input type="checkbox" name="expressTrait" id="expressTrait2" value="干练" aria-required="true" required/>干练
				                	<input type="checkbox" name="expressTrait" id="expressTrait3" value="效率" aria-required="true" required/>效率
								</td>
							</tr>
	...
	function initEditUser(getSelection){
		...
		$('#expressTrait1').attr('checked',getSelection.expressTrait.indexOf("耐心")!=-1);
		$('#expressTrait2').attr('checked',getSelection.expressTrait.indexOf("干练")!=-1);
		$('#expressTrait3').attr('checked',getSelection.expressTrait.indexOf("效率")!=-1);
