...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`one08` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `express_company`(`id`,`express_name`,`status`,`create_time`) values (1,'圆通快递',NULL,NULL),(2,'中通快递',NULL,NULL);
...
insert  into `express_person`(`id`,`express_name`,`sex`,`express_trait`,`entry_time`,`create_time`,`express_type_id`) values (1,'张','男','耐心','2020-08-06','2001-01-01',1),(2,'李四','女','干练','2020-08-01','2001-01-01',2),(4,'王五','男','耐心,干练','2020-08-20','2020-08-06',2);
...
insert  into `log`(`logId`,`userName`,`createTime`,`content`,`operation`,`ip`,`module`) values (1,'test','2017-11-29 14:31:04',NULL,'退出',NULL,NULL),(2,'test','2017-11-29 14:31:14',NULL,'登录','192.168.1.17',NULL),(3,'admin','2020-08-06 21:29:14',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(4,'admin','2020-08-06 23:25:41',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(5,'admin','2020-08-06 23:25:47','intercept the method: com.xiaoshu.controller.ExpressController.userList\r\n### Error querying database.  Cause: com.mysql.jdbc.exceptions.jdbc4.MySQLIntegrityConstraintViolationException: Column \'express_name\' in where clause is ambiguous\r\n### The error may exist in file [F:\\工作空间\\one03\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\one08\\WEB-INF\\classes\\mapper\\ExpressPersonMapper.xml]\r\n### The error may involve com.xiaoshu.dao.ExpressPersonMapper.findAll-Inline\r\n### The error occurred while setting parameters\r\n### SQL: SELECT count(0) FROM express_person p, express_company c WHERE p.express_type_id = c.id AND express_name LIKE \'%张%\'\r\n### Cause: com.mysql.jdbc.exceptions.jdbc4.MySQLIntegrityConstraintViolationException: Column \'express_name\' in where clause is ambiguous\n; SQL []; Column \'express_name\' in where clause is ambiguous; nested exception is com.mysql.jdbc.exceptions.jdbc4.MySQLIntegrityConstraintViolationException: Column \'express_name\' in where clause is ambiguous','拦截到异常','0:0:0:0:0:0:0:1','/one08'),(6,'admin','2020-08-06 23:25:52','intercept the method: com.xiaoshu.controller.ExpressController.userList\r\n### Error querying database.  Cause: com.mysql.jdbc.exceptions.jdbc4.MySQLIntegrityConstraintViolationException: Column \'express_name\' in where clause is ambiguous\r\n### The error may exist in file [F:\\工作空间\\one03\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\one08\\WEB-INF\\classes\\mapper\\ExpressPersonMapper.xml]\r\n### The error may involve com.xiaoshu.dao.ExpressPersonMapper.findAll-Inline\r\n### The error occurred while setting parameters\r\n### SQL: SELECT count(0) FROM express_person p, express_company c WHERE p.express_type_id = c.id AND express_name LIKE \'%张%\'\r\n### Cause: com.mysql.jdbc.exceptions.jdbc4.MySQLIntegrityConstraintViolationException: Column \'express_name\' in where clause is ambiguous\n; SQL []; Column \'express_name\' in where clause is ambiguous; nested exception is com.mysql.jdbc.exceptions.jdbc4.MySQLIntegrityConstraintViolationException: Column \'express_name\' in where clause is ambiguous','拦截到异常','0:0:0:0:0:0:0:1','/one08'),(7,'admin','2020-08-06 23:25:53','intercept the method: com.xiaoshu.controller.ExpressController.userList\r\n### Error querying database.  Cause: com.mysql.jdbc.exceptions.jdbc4.MySQLIntegrityConstraintViolationException: Column \'express_name\' in where clause is ambiguous\r\n### The error may exist in file [F:\\工作空间\\one03\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\one08\\WEB-INF\\classes\\mapper\\ExpressPersonMapper.xml]\r\n### The error may involve com.xiaoshu.dao.ExpressPersonMapper.findAll-Inline\r\n### The error occurred while setting parameters\r\n### SQL: SELECT count(0) FROM express_person p, express_company c WHERE p.express_type_id = c.id AND express_name LIKE \'%张%\'\r\n### Cause: com.mysql.jdbc.exceptions.jdbc4.MySQLIntegrityConstraintViolationException: Column \'express_name\' in where clause is ambiguous\n; SQL []; Column \'express_name\' in where clause is ambiguous; nested exception is com.mysql.jdbc.exceptions.jdbc4.MySQLIntegrityConstraintViolationException: Column \'express_name\' in where clause is ambiguous','拦截到异常','0:0:0:0:0:0:0:1','/one08'),(8,'admin','2020-08-06 23:26:24','intercept the method: com.xiaoshu.controller.ExpressController.userList\r\n### Error querying database.  Cause: com.mysql.jdbc.exceptions.jdbc4.MySQLIntegrityConstraintViolationException: Column \'express_name\' in where clause is ambiguous\r\n### The error may exist in file [F:\\工作空间\\one03\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\one08\\WEB-INF\\classes\\mapper\\ExpressPersonMapper.xml]\r\n### The error may involve com.xiaoshu.dao.ExpressPersonMapper.findAll-Inline\r\n### The error occurred while setting parameters\r\n### SQL: SELECT count(0) FROM express_person p, express_company c WHERE p.express_type_id = c.id AND express_name LIKE \'%张%\'\r\n### Cause: com.mysql.jdbc.exceptions.jdbc4.MySQLIntegrityConstraintViolationException: Column \'express_name\' in where clause is ambiguous\n; SQL []; Column \'express_name\' in where clause is ambiguous; nested exception is com.mysql.jdbc.exceptions.jdbc4.MySQLIntegrityConstraintViolationException: Column \'express_name\' in where clause is ambiguous','拦截到异常','0:0:0:0:0:0:0:1','/one08'),(9,'admin','2020-08-06 23:27:55',NULL,'退出',NULL,NULL),(10,'admin','2020-08-06 23:28:05',NULL,'登录','0:0:0:0:0:0:0:1',NULL);
