				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>学生姓名：</td>
								<td colspan="4"><input type="text" id="sdname" name="sdname"
							...
							<tr>
								<td>学生爱好：</td>
								<td colspan="4">
									<input type="checkbox" id="sdhobby1" name="sdhobby" value="篮球" required/>篮球
									<input type="checkbox" id="sdhobby2" name="sdhobby" value="足球" required/>足球
									<input type="checkbox" id="sdhobby3" name="sdhobby" value="排球" required/>排球
								</td>
							</tr>
							<tr>
								<td>学生生日：</td>
								<td colspan="4"><input type="date" id="sdbirth" name="sdbirth"
									class="form-control" aria-required="true" required/></td>
							</tr>
							<tr>
								<td>专业：</td>
				...
				<div class="modal-body">
					<form id="form_addtemp" method="post" action="addtemp.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>学生姓名：</td>
								<td colspan="4"><input type="text" name="mdname" required/></td>
							</tr>
						</table>
						
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="submit_addtemp">保存</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						</div>
					</form>
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_echarts").click(function(){
	    			var echartstb = echarts.init(document.getElementById("main"));
	    			    ...
	    			    success:function(res){
	    			    	...
	    			    	if(res.success){
		    			    	...
		    			    	res.elist.forEach(function(emp){
		    			    		xdata.push(emp.mname);
		    			    		ydata.push({value:emp.num,name:emp.mname});
		    			    		option = {
		    			    			    xAxis: {
		    			    			        type: 'category',
		    			    			        data:xdata,
