...
public class ExpressService {
	...
	public PageInfo<Express> findUserPage(Express express, Integer pageNum, Integer pageSize, String ordername,
			String order) {
		PageHelper.startPage(pageNum, pageSize);
		ordername = StringUtil.isNotEmpty(ordername)?ordername:"kid";
		order = StringUtil.isNotEmpty(order)?order:"desc";
	...
	ExpressExample example = new ExpressExample();
		Criteria criteria = example.createCriteria();
		criteria.andKnameEqualTo(userName);
		...
		public void updateUser(Express express) throws Exception {
		...
		public void deleteUser(Integer kid) throws Exception {
		expressMapper.deleteByPrimaryKey(kid);
	};
