...
<body class="gray-bg">
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<td>学生性别：</td>
								<td>
									<input type="radio" id="sex" name="sex" value="男" class="form-control" aria-required="true" required/>男
									<input type="radio" id="sex" name="sex" value="女" class="form-control" aria-required="true" required/>女
									</td>
							<tr>
								<td>学校名称：</td>
								<td colspan="4">
	...
	function initEditUser(getSelection){
		...
		$('#dname').val(getSelection.dname);
		$('#cname').val(getSelection.cname);
		$("input[value='"+getSelection.sex+"']").prop('checked',true)
		$('#ddate').val(new Date(getSelection.ddate).Format("yyyy-MM-dd"));
	}
