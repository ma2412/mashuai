...
<body class="gray-bg">
        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="text" name="kname" class="form-control" id="txt_search_username" >
				</div>
			  </div>
			  <div class="col-lg-2">
			 </div>
			...
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveExpress.htm">
						<input type="hidden" name="kid" id="hidden_txt_userid" value=""/>
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>快递名称：</td>
								<td><input type="text" id="kname" name="kname"
							...
							<tr>
								<td>成立时间：</td>
								<td colspan="4">
									<input type="date" id="kdate" name="kdate"
									class="form-control" aria-required="true" required/>
								</td>
							</tr>
							<tr>
								<td valign="middle">注入资金：</td>
								<td colspan="4"><textarea rows="7" cols="50"
										name="price" id="price"></textarea></td>
							</tr>
						</table>
	...
	function initEditUser(getSelection){
		$('#hidden_txt_userid').val(getSelection.kid);
		$('#area').val(getSelection.area);
		$('#kname').val(getSelection.kname);
		$('#kdate').val(new Date(getSelection.kdate).Format("yyyy-MM-dd"));
