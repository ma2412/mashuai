...
<body class="gray-bg">
        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="text" name="contenttitle" class="form-control" id="tcontenttitle" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
					<span class="input-group-addon">角色</span>
					<select class="form-control" name="contentcategoryid" id = "tcontentcategoryid">
	...
	<div class="modal fade" id="modal_user_import" role="dialog" aria-labelledby="modal_user_import" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
						<form action="importContent.htm" id="contentid" method="post" enctype="multipart/form-date">
	...
	$(function () {
	    ...
	    var validator = $("#contentid").validate({
    		submitHandler: function(form){
   		      $(form).ajaxSubmit({
   		    	dataType:"json",
   		    	success: function (data) {
	...
	var TableInit = function () {
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            contenttitle: $("#tcontenttitle").val(),
	            contentcategoryid: $("#tcontentcategoryid").val(),
	...
	function initEditUser(getSelection){
		$('#contentid').val(getSelection.contentid);
