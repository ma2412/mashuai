...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`one04` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `content` (
  ...
  `contenttitle` varchar(20) DEFAULT NULL,
  `contenturl` varchar(20) DEFAULT NULL,
...
insert  into `content`(`contentid`,`contentcategoryid`,`contenttitle`,`contenturl`,`picpath`,`price`,`status`,`createtime`) values (1,1,'限时促销','www.xiliang.com','1.png','500','启用','2020-07-31'),(2,2,'销量冠军','www.xiaoliang.com','1.png','500','启用','2020-07-31'),(3,1,'热卖爆款','www.jiyun.com','2.png','500','禁用','2020-07-31'),(4,2,'未来之星','www.jiyun.com','1.png','500','启用','2020-07-31');
...
insert  into `contentcategory`(`contentcategoryid`,`categoryname`,`status`,`createtime`) values (1,'品牌广告','启用','2000-01-01'),(2,'产品广告','禁用','2000-01-01');
...
insert  into `log`(`logId`,`userName`,`createTime`,`content`,`operation`,`ip`,`module`) values (1,'test','2017-11-29 14:31:04',NULL,'退出',NULL,NULL),(2,'test','2017-11-29 14:31:14',NULL,'登录','192.168.1.17',NULL),(3,'admin','2020-07-31 18:37:43',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(4,'admin','2020-07-31 19:03:52',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(5,'admin','2020-07-31 19:06:59',NULL,'退出',NULL,NULL),(6,'admin','2020-07-31 19:07:08',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(7,'admin','2020-07-31 19:43:21',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(8,'admin','2020-07-31 20:23:41',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(9,'admin','2020-07-31 20:27:33',NULL,'登录','127.0.0.1',NULL),(10,'admin','2020-08-02 08:09:08',NULL,'登录','0:0:0:0:0:0:0:1',NULL);
...
insert  into `user`(`userId`,`userName`,`password`,`userType`,`roleId`,`userDescription`) values (1,'admin','admin',NULL,1,'超级管理员，供开发方使用');
