					...
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<td>商品状态：</td>
								<td>
									<select class="form-control" name="status" aria-required="true" required>
										<option value="">---请选择---</option>
	    	...
	    	$("#btn_echarts").click(function(){
	    			...
	    			$.ajax({
	    			    ...
	    			    success:function(res){
	    			    	...
	    			    	if(res.success){
		    		    		//循环集合
		    			    	res.elist.forEach(function(goods){
		    			    		xdata.push(goods.tname);
		    			    		ydata.push({value:goods.num,name:goods.tname});
		    			    	})
		    			    	option = {
		    			    		    title: {
		    			    		        text: '某站点用户访问来源',
