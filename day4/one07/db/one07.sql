...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`one07` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `log`(`logId`,`userName`,`createTime`,`content`,`operation`,`ip`,`module`) values (1,'test','2017-11-29 14:31:04',NULL,'退出',NULL,NULL),(2,'test','2017-11-29 14:31:14',NULL,'登录','192.168.1.17',NULL),(3,'admin','2020-08-04 10:50:39',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(4,'admin','2020-08-04 10:50:39',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(5,'admin','2020-08-04 10:50:56',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(6,'admin','2020-08-04 10:52:50',NULL,'退出',NULL,NULL),(7,'admin','2020-08-04 10:53:01',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(8,'admin','2020-08-04 14:52:55',NULL,'登录','0:0:0:0:0:0:0:1',NULL);
...
insert  into `p_company`(`company_id`,`company_name`) values (1,'圆通快递'),(2,'申通快递');
...
insert  into `p_person`(`id`,`p_name`,`gender`,`company_id`,`date`) values (1,'张三','男',1,'2020-08-04'),(2,'王五','男',1,'2020-08-04'),(5,'熊大','男',1,'2020-08-04');
