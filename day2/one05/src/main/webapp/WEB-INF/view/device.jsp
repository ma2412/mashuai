        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="text" name="devicename" class="form-control" id="ddevicename" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
					<span class="input-group-addon">设备状态</span>
					<select class="form-control" name="status" id ="dddstatus">
...
创建时间  -->
	...
	function initEditUser(getSelection){
		$('#deviceid').val(getSelection.deviceid);
