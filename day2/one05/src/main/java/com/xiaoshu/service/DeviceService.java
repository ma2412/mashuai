...
/*	@Autowired
	...
	@Autowired
	private DevicetypeMapper d;
	
	public PageInfo<Device> findUserPage(Device device, Integer pageNum, Integer pageSize, String ordername,
			String order) {
		PageHelper.startPage(pageNum, pageSize);
	...
	public void addUser(Device device) {
		// TODO Auto-generated method stub
		deviceMapper.insert(device);
	}

	public void updateUser(Device device) {
		// TODO Auto-generated method stub
	...
	public List<Devicetype> findToo() {
		// TODO Auto-generated method stub
		return d.selectAll();
	}

	public List<Device> findLog(Device device) {
		// TODO Auto-generated method stub
		return deviceMapper.findAll(device);
	}
