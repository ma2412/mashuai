...
<body class="gray-bg">
        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="text" name="sname" class="form-control" id="text_sname" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
					<span class="input-group-addon">学校名称</span>
					<select class="form-control" name="tid" id ="text_tid">
					...
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td>学生生日：</td>
								<td><input type="date" id="sdate" name="sdate" aria-required="true" required/></td>
							</tr>
							<tr>
								<td>学生年龄：</td>
								<td><input type="text" id="sage" name="sage"
									class="form-control" aria-required="true" required/></td>
								<td>&nbsp;&nbsp;</td>
								<td>学生性别：</td>
								<td>
	...
	function initEditUser(getSelection){
		...
		$('#sage').val(getSelection.sage);
		$("input[value='"+getSelection.ssex+"']").prop('checked',true);
		$('#tid').val(getSelection.tid);
		$('#sdate').val(new Date(getSelection.sdate).Format('yyyy-MM-dd'));
	}
